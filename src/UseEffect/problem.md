- Fetching Data: Create a component that fetches data from an API when it mounts using useEffect. - `Done`
...
- Updating Document Title: Create a component that updates the document title based on a state variable using useEffect.
